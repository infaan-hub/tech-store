      ...
      <section className="about-home-section" aria-labelledby="about-us-title">
        <div className="about-home-card">
          <div className="about-home-copy">
            ...
            <p className="muted">
              Tech store serves customers across Zanzibar with phones, accessories, gadgets, and everyday tech
              essentials, plus quick delivery support. We focus on making shopping simple, reliable, and friendly for
              local families, visitors, and busy customers who want trusted products in one place.
            </p>
          </div>
          <div className="about-home-links" aria-label="Contact Tech store">
            {aboutLinks.map((link) => (
