...
STORE_SUBTITLE = "Phones, accessories, gadgets, and daily tech essentials in Zanzibar."
STORE_PHONE = "+255 711 252 758"
STORE_EMAIL = "info@techstore.local"
...
RECEIPT_ABOUT_CARDS = [
    (
        "Fresh supply",
        "We connect Zanzibar shoppers with trusted suppliers for phones, accessories, gadgets, and daily tech essentials.",
    ),
    (
        "Fast discovery",
