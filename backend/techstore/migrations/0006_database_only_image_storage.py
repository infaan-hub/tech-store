...
def migrate_files_to_database(apps, schema_editor):
    CustomUser = apps.get_model("techstore", "CustomUser")
    Product = apps.get_model("techstore", "Product")
    Payment = apps.get_model("techstore", "Payment")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("techstore", "0005_product_database_image_storage"),
    ]
