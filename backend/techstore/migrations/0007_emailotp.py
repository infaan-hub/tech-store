...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("techstore", "0006_database_only_image_storage"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="email_otps", to="techstore.customuser"),
                ),
            ],
            options={
                "ordering": ["-created_at"],
